...
public class MountainsSteep extends MountainBiome {

	private static MountainsSteep INSTANCE;

	private static final Biome BIOME = Biome.builder().name(NamespaceID.from("wgp:mountains_steep")).build();

	public MountainsSteep(WorldGen wg) {
	...
	public static MountainsSteep getInstance() {
		return INSTANCE;
	}
